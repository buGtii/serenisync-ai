  ...
  return (
    <footer className="border-t border-border mt-24 bg-background/50">
      <div className="container mx-auto px-4 py-10 grid gap-6 md:grid-cols-3 text-sm text-muted-foreground">
        <div>
          <div className="font-serif text-lg text-foreground">PsyDx</div>
      ...
      <div className="border-t border-border py-4 text-center text-xs text-muted-foreground">© {new Date().getFullYear()} PsyDx</div>
    </footer>
  );
}
