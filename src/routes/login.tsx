  ...
  return (
    <div className="min-h-[100dvh] bg-background text-foreground">
      <header className="sticky top-0 z-10 flex h-14 items-center px-3 backdrop-blur">
        ...
        <div className="ml-1 font-serif text-lg">Log in</div>
      </header>
        ...
        <Card className="p-6 border-border/60 bg-card/80 backdrop-blur shadow-soft rounded-2xl">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div>
              ...
              <Input id="pw" type="password" autoComplete="current-password" required minLength={6}
                className="h-12 rounded-xl mt-1"
          ...
          <p className="mt-5 text-sm text-center text-muted-foreground">
            No account? <Link to="/signup" className="text-accent underline-offset-4 hover:underline">Sign up</Link>
          </p>
        </Card>
      </div>
    </div>
