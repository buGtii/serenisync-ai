...
function DSMIndex() {
  ...
  return (
    <div className="container max-w-5xl mx-auto px-6 py-12">
      ...
      <p className="mt-2 text-muted-foreground max-w-2xl">Structured, paraphrased summaries of every DSM-5-TR chapter. Verbatim APA text is never stored — these are educational frameworks.</p>
